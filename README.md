# @diotoborg/maxime-placeat-deserunt
...
[![npm version](https://img.shields.io/npm/v/@diotoborg/maxime-placeat-deserunt)](https://img.shields.io/npm/v/@diotoborg/maxime-placeat-deserunt)
...
```bash
npm install @diotoborg/maxime-placeat-deserunt

# or 

yarn add @diotoborg/maxime-placeat-deserunt

# or

pnpm add @diotoborg/maxime-placeat-deserunt
```

Import and use it:

```javascript
import { parseSchema } from '@diotoborg/maxime-placeat-deserunt';
